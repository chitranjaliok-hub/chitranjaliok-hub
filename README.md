...
- **Machine Learning:** Classification, Clustering, Ensemble Learning, Feature Engineering, Model Evaluation, Hyperparameter Tuning
- **Data Visualization & BI:** Tableau, Matplotlib, Seaborn
- **Generative AI:** Large Language Models (LLMs), Prompt Engineering, GenAI Applications
- **SQL:** MySQL, Joins, CTEs, Subqueries, Window Functions, Aggregations
...
### Quality Analyst
**Mithr Artificial Intelligence Pvt. Ltd. | Madurai**

* Conducted functional, regression, smoke, and exploratory testing for web and mobile applications
* Prepared test cases, defect reports, and QA status updates
* Collaborated with development teams to verify fixes and improve product quality

### Purchase & Procurement Executive
**PC World | Madurai**

* Managed procurement of computer products and monitored inventory levels
* Maintained supplier accounts and monitored sales and billing
* Conducted stock audits and supported inventory management

### Senior Consultant / Team Lead – Email & Chat Support
**Sutherland Global Services Pvt. Ltd. | Chennai**

* Handled customer support operations through email and chat
* Promoted to Team Lead and supported team coordination and mentoring
* Ensured timely and accurate resolution of customer queries
